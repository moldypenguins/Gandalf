...
Mordor.connection.once("open", () => {
  ...
  app.use(async (req, res, next) => {
    ...
    if(req.session?.member !== undefined && req.session.member != null) {
      ...
      res.locals.member.telegram_name = await FNCS.getTelegramName(res.locals.member);
      console.log('telegram_name: ' + util.inspect(res.locals.member.telegram_name, false, null, true));
